...
from gemini_pro_bot2.filters import AuthFilter, MessageFilter, PhotoFilter
from dotenv import load_dotenv
from gemini_pro_bot2.handlers import (
    start,
    help_command,
    newchat_command,
    handle_message,
...
def start_bot1() -> None:
    ...
    application = Application.builder().token(os.getenv("BOT_TOKEN2")).build()
